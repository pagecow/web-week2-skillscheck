...
let faveColors = ['white', 'blue', 'gray']
...
let me = {
    firstName: 'TJ',
    superHeroName: 'Chronic Illness Terminator',
    homeTown: 'Verocious Vibes, Alabama',
    superPowers: ['super psychic chronic illness mental detection', 'force manipulation', 'crying rivers of tears in dry, desert places'],
